        ...
        <section className="cf mt4 mb3 pa3 pa4-l bg-white shadow br3">
          ...
          <form>
            <div className="mb4">
              ...
              <input id="name" required type="text" className="w-100 pa3 br2 b--black-20" />
            </div>
            ...
            <div className="mb4">
              ...
              <input id="email" required type="email" className="w-100 pa3 br2 b--black-20" />
            </div>
            ...
            <div className="mb4">
              <p>
                New users will get an email notification with a link to set their
                password.
              </p>
            </div>
