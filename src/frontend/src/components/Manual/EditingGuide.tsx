...
export default class EditingGuide extends React.Component<Props, State> {
  state = { open: false };
  render() {
    return (
      <>
        ...
        >
          ...
          <div className="flex-l">
            <p className="mb2">
              ...
              <DisclosureButton className="mt1 ml3 fw7">
          ...
          <DisclosurePanel className="ml2 pt2">
            ...
            <section className="mb4">
              <p className="mb3">
                ...
                person’s true record. This can happen for a few reasons:
              </p>
              <ol className="mh4">
                <li className="mb3 pb1">
                  The search returns the wrong person’s record: In the rare
                  event that a different person’s Oregon record shares a birth
                  date and name with the person of interest, these records may
                ...
                <li className="mb3 pb1">
                  ...
                  case is missing or incorrect in OECI.
                </li>
                <li className="mb3 pb1">
              ...
              <p className="mb3">
                This lets you create a new case from scratch that can be
                populated with new charges. You must provide the case Current
              ...
              <p className="mt3">
                {" "}
                Creating or editing a case will add a badge to that case
                indicating that the case was created or edited. You can click
                the badge to undo the change.
              </p>
