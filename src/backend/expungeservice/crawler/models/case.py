...
class Case:
    ...
    def __init__(self, info, case_number, citation_number, date_location, type_status, charges, case_detail_link):
        ...
        self.violation_type, self.current_status = type_status #todo:  i think violation_type is supposed to be 'severity_level': infraction/violation , misdemeanor, felony
        #todo: also violation_type returns the word "offense" which is probably not necessary
