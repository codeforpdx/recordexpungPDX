...
class RecordParser(HTMLParser):
    ...
    def __record_case(self): #todo: unpacking these variables like this feels wrong
        self.cases.append(Case(self.info[0], self.info[1], self.case_number, self.citation_number, self.date_location[0], self.date_location[1], self.type_status[0], self.type_status[1], self.charges, self.case_detail_link))
