...
class FelonyClassC(ChargeType):
    ...
    expungement_rules: str = """There are certain types of Class C felony which are generally ineligible, including sex crimes, child abuse, elder abuse, traffic crimes, and criminally negligent homicide.
    ...
    def type_eligibility(self, disposition):
        if ChargeUtil.dismissed(disposition):
            ...
            return TypeEligibility(
                ...
                reason="Eligible under 137.225(1)(b) for convictions or under 137.225(1)(d) for dismissals",
            )
