...
"""
    ...
    statutes = [
        ...
        # "163355",  # [Sex Crimes] Rape III;
        # "163365",  # [Sex Crimes] Rape II;
        # "163375",  # [Sex Crimes] Rape I;
        # "163385",  # [Sex Crimes] Sodomy III;
        # "163395",  # [Sex Crimes] Sodomy II;
        # "163405",  # [Sex Crimes] Sodomy I;
        # "163408",  # [Sex Crimes] Sexual Penetration II;
        # "163411",  # [Sex Crimes] Sexual Penetration I;
        # "163413",  # [Sex Crimes] Purchasing Sex With a Minor;
        # "163425",  # [Sex Crimes] Sexual Abuse II;
        # "163427",  # [Sex Crimes] Sexual Abuse I;
        # "163432",  # [Sex Crimes] Online Sexual Corruption of a Child II;
        # "163433",  # [Sex Crimes] Online Sexual Corruption of a Child I;
        # "163452",  # [Sex Crimes] Custodial Sexual Misconduct in the First Degree;
        # "163465",  # [Sex Crimes] Felony Public Indecency;
        # "163472",  # [Sex Crimes] Unlawful Dissemination of Intimate Image;
        # "163479",  # [Sex Crimes] Unlawful Contact with a Child;
        "163525",  # Incest;
        "163535",  # Abandon Child;
        "163537",  # Buying/Selling Custody of a Minor;
        "163547",  # Child Neglect I;
        # "163670",  # [Sex Crimes] Using Child In Display of Sexual Conduct;
        # "163684",  # [Sex Crimes] Encouraging Child Sex Abuse I;
        # "163686",  # [Sex Crimes] Encouraging Child Sex Abuse II;
        # "163688",  # [Sex Crimes] Possession of Material Depicting Sexually Explicit Conduct of Child I;
        # "163689",  # [Sex Crimes] Possession of Material Depicting Sexually Explicit Conduct of Child II;
