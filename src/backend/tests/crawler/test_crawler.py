...
class TestCrawler(unittest.TestCase):
    ...
    def test_search_function(self):
        ...
        assert record.cases[2].charges[0].disposition.ruling is ''
        assert record.cases[2].charges[0].disposition.date is ''
        assert record.cases[2].charges[1].disposition.ruling is ''
        assert record.cases[2].charges[1].disposition.date is ''
        assert record.cases[2].charges[2].disposition.ruling is ''
        assert record.cases[2].charges[2].disposition.date is ''
