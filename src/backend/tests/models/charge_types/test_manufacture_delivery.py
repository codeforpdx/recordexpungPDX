...
def test_manufacture_delivery_manudel_felony_unclassified():
    ...
    assert (
        type_eligibility.reason
        == "Convictions that fulfill the conditions of 137.225(5)(a) are eligible, Eligible under 137.225(5)(b), Eligible under 137.226, Ineligible by omission from statute"
    )
...
def test_manufacture_delivery_1():
    ...
    assert (
        type_eligibility.reason
        == "Convictions that fulfill the conditions of 137.225(5)(a) are eligible, Ineligible by omission from statute"
    )
