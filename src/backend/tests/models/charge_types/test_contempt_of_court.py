...
def test_contempt_of_court_dismissed():
    ...
    assert charge.expungement_result.type_eligibility.reason == "Ineligible under 137.225(1)(b) ommission from statute (for dismissals)"
...
def test_contempt_of_court_convicted():
    ...
    assert charge.expungement_result.type_eligibility.reason == "Misdemeanors are always eligible under 137.225(5)(b) for convictions, or 137.225(1)(b) for dismissals"
