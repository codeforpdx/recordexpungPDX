...
RETURNS TABLE (USER_ID VARCHAR, EMAIL CITEXT, ADMIN BOOLEAN, AUTH_ID VARCHAR, HASHED_PASSWORD TEXT, DATE_CREATED TIMESTAMP WITH TIME ZONE, DATE_MODIFIED TIMESTAMP WITH TIME ZONE)
as $$
...
SELECT USERS.USER_ID::varchar, EMAIL, ADMIN, AUTH_ID::varchar, HASHED_PASSWORD, DATE_CREATED, DATE_MODIFIED
